...
import type { E, HasClock, HasConsole } from '@contentlayer2/utils/effect'
...
export const generateDotpkg = ({
  ...
  pipe(
    ...
    T.rightOrFail,
    OT.withSpan('@contentlayer2/core/generation:generateDotpkg', { attributes: { verbose } }),
  )
...
const successCallback = (onSuccess: SuccessCallback | undefined) => {
  ...
  return pipe(
    ...
    OT.withSpan('@contentlayer2/core/generation:successCallback'),
  )
}
